...
public final class FileUtils {
    ...
    /** 文件是用时间+随机数组成的,采用*分隔. */
    public final static String FILE_EXTENSION_SEPARATOR = "time";
    ...
    public static void deleteTimeoutFile(String cachePath,final int autoClearDay) {
        FileUtils.delete(cachePath, new FilenameFilter() {
            @Override
