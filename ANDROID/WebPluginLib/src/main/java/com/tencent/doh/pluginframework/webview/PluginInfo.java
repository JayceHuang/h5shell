...
public class PluginInfo {
    ...
    public PluginInfo(Class<? extends WebViewPlugin> classType, String namespace, String desc, String version) {
        this(classType, namespace, desc, version, true);
    }
    public PluginInfo(Class<? extends WebViewPlugin> classType, String namespace, String desc, String version, boolean async) {
