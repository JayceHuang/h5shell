...
public final class StorageUtils {
            ...
            synchronized (InnerEnvironment.class) {
                ...
                if (!externalFilesDir.exists()) {
                    ...
                    if (!externalFilesDir.mkdirs()) {
                        LogUtils.w(TAG, "Unable to create external files directory");
                        return null;
                    }
                }
                if (type == null) {
                ...
                if (!dir.exists()) {
                    if (!dir.mkdirs()) {
                        LogUtils.w(TAG, "Unable to create external media directory " + dir);
                        return null;
                    }
                }
                return dir;
    ...
    public static String getExternalCacheDir(Context context, String name, boolean persist) {
        ...
        try{
            ...
            LogUtils.e("StorageUtil","getExternalCacheDir exception occours:"+ ex.getMessage());
        }
