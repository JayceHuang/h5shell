...
public class CropImageView extends ImageView {
    ...
    public CropImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        int[] CropImageViewIds = MResource.getIdsByName(context,"styleable","CropImageView");
        TypedArray a = context.obtainStyledAttributes(attrs,CropImageViewIds);
...
//        mDefaultStyleIndex = a.getInteger(R.styleable.CropImageView_cropStyle, mDefaultStyleIndex);
        mMaskColor = a.getColor(MResource.getIdByName(context,"styleable","CropImageView_cropMaskColor"), mMaskColor);
        mBorderColor = a.getColor(MResource.getIdByName(context,"styleable","CropImageView_cropBorderColor"), mBorderColor);
        mBorderWidth = a.getDimensionPixelSize(MResource.getIdByName(context,"styleable","CropImageView_cropBorderWidth"), mBorderWidth);
        mFocusWidth = a.getDimensionPixelSize(MResource.getIdByName(context,"styleable","CropImageView_cropFocusWidth"), mFocusWidth);
        mFocusHeight = a.getDimensionPixelSize(MResource.getIdByName(context,"styleable","CropImageView_cropFocusHeight"), mFocusHeight);
        mDefaultStyleIndex = a.getInteger(MResource.getIdByName(context,"styleable","CropImageView_cropStyle"), mDefaultStyleIndex);
