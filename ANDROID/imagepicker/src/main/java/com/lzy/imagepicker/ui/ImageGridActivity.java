...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, ImageGridAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int layoutId = MResource.getIdByName(this,"layout","txwp_activity_image_grid");
        ...
        int btnDirId = MResource.getIdByName(this,"id","btn_dir");
        int btnPreviewId = MResource.getIdByName(this,"id","btn_preview");
        int gridViewId = MResource.getIdByName(this,"id","gridview");
        int footerBarId = MResource.getIdByName(this,"id","footer_bar");

        findViewById(btnBackId).setOnClickListener(this);
        mBtnOk = (Button) findViewById(btnOkId);
        mBtnOk.setOnClickListener(this);
        mBtnDir = (Button) findViewById(btnDirId);
        mBtnDir.setOnClickListener(this);
        mBtnPre = (Button) findViewById(btnPreviewId);
        mBtnPre.setOnClickListener(this);
        mGridView = (GridView) findViewById(gridViewId);
        mFooterBar = findViewById(footerBarId);
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        int selectCompleteId = MResource.getIdByName(this,"string","txwp_select_complete");
        int completeId = MResource.getIdByName(this,"string","txwp_complete");
        int previewCountId = MResource.getIdByName(this,"string","txwp_preview_count");
        ...
        mBtnPre.setText(getResources().getString(previewCountId, imagePicker.getSelectImageCount()));
...
//                    setResult(ImagePicker.RESULT_CODE_ITEMS, intent);   //单选不需要裁剪，返回数据
//                    finish();
                    cameraCompletePreview(imageItem);
                }
            }
        }
    }

    private void cameraCompletePreview(ImageItem imageItem) {
        Intent intent = new Intent(this, ImagePreviewActivity.class);
        intent.putExtra(ImagePicker.EXTRA_SELECTED_IMAGE_POSITION, 0);
        ArrayList<ImageItem> reqImages = new ArrayList<>(1);
        reqImages.add(imageItem);
