...
public class FolderPopUpWindow extends PopupWindow implements View.OnClickListener {
    ...
    public FolderPopUpWindow(Context context, BaseAdapter adapter) {
        super(context);
        int folderId = MResource.getIdByName(context,"layout","txwp_pop_folder");
        final View view = View.inflate(context, folderId, null);
        int maskerId = MResource.getIdByName(context,"id","masker");
        int marginViewId = MResource.getIdByName(context,"id","margin");
        int listViewId = MResource.getIdByName(context,"id","listView");

        masker = view.findViewById(maskerId);
        masker.setOnClickListener(this);
        marginView = view.findViewById(marginViewId);
