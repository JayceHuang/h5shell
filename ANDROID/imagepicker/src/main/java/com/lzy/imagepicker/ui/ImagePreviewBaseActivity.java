...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int layoutId = MResource.getIdByName(this,"layout","txwp_activity_image_preview");
        ...
        int contentId = MResource.getIdByName(this,"id","content");
        int topBarId = MResource.getIdByName(this,"id","top_bar");
        int btnOkId = MResource.getIdByName(this,"id","btn_ok");
        int btnBackId = MResource.getIdByName(this,"id","btn_back");
        int tvDesId = MResource.getIdByName(this,"id","tv_des");
        int viewpagerId = MResource.getIdByName(this,"id","viewpager");

        //初始化控件
        content = findViewById(contentId);

        //因为状态栏透明后，布局整体会上移，所以给头部加上状态栏的margin值，保证头部不会被覆盖
        topBar = findViewById(topBarId);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) topBar.getLayoutParams();
            params.topMargin = Utils.getStatusHeight(this);
            topBar.setLayoutParams(params);
        }
        topBar.findViewById(btnOkId).setVisibility(View.GONE);
        topBar.findViewById(btnBackId).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mTitleCount = (TextView) findViewById(tvDesId);

        mViewPager = (ViewPagerFixed) findViewById(viewpagerId);
        ...
        int imageCountId = MResource.getIdByName(this,"string","txwp_preview_image_count");
