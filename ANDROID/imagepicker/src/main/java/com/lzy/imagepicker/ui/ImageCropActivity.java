...
public class ImageCropActivity extends ImageBaseActivity implements View.OnClickListener, CropImageView.OnBitmapSaveCompleteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int layoutId = MResource.getIdByName(this,"layout","txwp_activity_image_crop");
        ...
        int cvCropImageId = MResource.getIdByName(this,"id","cv_crop_image");

        int completeId = MResource.getIdByName(this,"string","txwp_complete");
        int photoCropId = MResource.getIdByName(this,"string","txwp_photo_crop");

        //初始化View
        findViewById(btnBackId).setOnClickListener(this);
        Button btn_ok = (Button) findViewById(btnOkId);
        btn_ok.setText(getString(completeId));
        btn_ok.setOnClickListener(this);
        TextView tv_des = (TextView) findViewById(tvDesId);
        tv_des.setText(getString(photoCropId));
        mCropImageView = (CropImageView) findViewById(cvCropImageId);
